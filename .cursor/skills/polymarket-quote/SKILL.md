...
| Odds confirmation | `data/pm-quote/book_context_observe.jsonl` | AF-confirmed goals at 0/1/…/60s: Odds-API.io score + Bet365 full markets, A/B/C reason, change fingerprint and upgrade action |
