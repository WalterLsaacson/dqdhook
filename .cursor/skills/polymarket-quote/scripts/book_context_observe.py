...
class BookContextObserver:
    ...
    def sample_gate_tick(
        ...
        *,
        ...
        """One Odds/Bet365 snapshot on the pitch-gate clock. Never sizes or upgrades."""
        ...
        dqd_score = {"home": ev.get("home_score"), "away": ev.get("away_score")}
        phase = "gate_reversal" if observe_only else "gate_goal"
        group_id = make_observe_group_id(
            mid, dqd_score.get("home"), dqd_score.get("away"), event_key
        )
        try:
