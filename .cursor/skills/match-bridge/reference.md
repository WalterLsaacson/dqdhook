...
- Poll cadence: **5s** while a **paired** row is Playing or `Played` but `period` ≠ `FT`; **600s** when no paired match needs watching. Unpaired worldwide live does not accelerate the poll.
